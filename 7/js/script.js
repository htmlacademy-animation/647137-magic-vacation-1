...
/***/ "./source/js/modules/fly-words.js":
/*!****************************************!*\
  !*** ./source/js/modules/fly-words.js ***!
  \****************************************/
/*! exports provided: default */
...
class AccentTypographyBuild { 
    ...
    createElement(letter, index) {    
        index = index + 1;
        //console.log('i=' + index + ',   ' + this._timeOffset)
        const span = document.createElement(`span`);
        span.textContent = letter;
        span.style.transition = `${this._property} ${this._timer}ms ease ${this._timeOffset}ms`;
        if (((index + 1) % 3) == 0) {
            this._timeOffset = this._timeOffset - 20;
        } else {
            this._timeOffset = this._timeOffset + 40;
        }
        return span;
    }
...
/* harmony default export */ __webpack_exports__["default"] = (AccentTypographyBuild);
...
/* harmony import */ var _modules_fly_words_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/fly-words.js */ "./source/js/modules/fly-words.js");
// modules
...
const animationIntroText = new _modules_fly_words_js__WEBPACK_IMPORTED_MODULE_10__["default"](`.text`, 600, `active`, `transform`);
const animationDateText = new _modules_fly_words_js__WEBPACK_IMPORTED_MODULE_10__["default"](`.date-text`, 600, `active`, `transform`);
